...
export default function PoliticaDePrivacidade() {
    ...
    return (
        <>
            <Helmet defer={false} >
                <title>Política de Privacidade | LuaCrypto </title>
                <meta
                    name="robots"
                    content="noindex"
                />
            </Helmet>
            <PageTitle title="Política de Privacidade de LuaCrypto" />
            <div>
                <h3>Política Privacidade</h3>
                <p>
                    A sua privacidade é importante para nós. É política do LuaCrypto respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a className="link" href="http://luacrypto.com">LuaCrypto</a>, e outros sites que possuímos e operamos.
                </p>
                <p>
                ...
                <h3>Política de Cookies LuaCrypto</h3>
                <br />
                ...
                <p>
                    O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o LuaCrypto oferece no site e com caráter enunciativo, mas não limitativo:</p>
                <ul>
                    <li>
                    ...
                    <li>
                        C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do LuaCrypto, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.
                    </li>
                </ul>
                ...
                <p>
                    Esta política é efetiva a partir de <span className="bold">Setembro de 2021</span>.
                </p>
            </div>
        </>
    );
